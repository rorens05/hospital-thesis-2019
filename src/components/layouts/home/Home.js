					...
					<div className='content'>
						<div className='home-container'>
							<div class='image-container'>
								<img src={window.localStorage.getItem('ROLE') == 'NURSE' ? nurse : user} alt='' />
							</div>
							...
							<MDBRow className='time-container'>
								<MDBCol size='6'>
									...
									<h6>Time</h6>
									<h5>
										{(this.state.time.getHours() % 12 == 0 ? 12 : this.state.time.getHours() % 12) +
											':' +
											this.state.time.getMinutes() +
											':' +
											this.state.time.getSeconds() +
											(this.state.time.getHours() < 12 ? ' AM' : ' PM')}
									</h5>
								</MDBCol>
								<MDBCol size='6'>
									<span>
